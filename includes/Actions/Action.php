...
abstract class Action {
	...
	public function hook() {
		add_filter( 'formiflex_available_form_actions', array( $this, 'register' ) );
		add_action( 'formiflex_process_form_action_' . $this->type, array( $this, 'process' ), 10, 3 );
	}
