...
class Email extends Action {
	 ...
	 * @param Formiflex\Form $form The form object.
	 */
	public function process( $action_settings, $form ) {
		...
		$to      = apply_filters( 'formiflex_action_email_to', $settings['to'] );
		$subject = ! empty( $settings['subject'] ) ? $settings['subject'] : '';
		$subject = apply_filters( 'formiflex_action_email_subject', $subject );
		$message = apply_filters( 'formiflex_action_email_message', $settings['message'] );
		...
		if ( ! empty( $settings['from'] ) ) {
			$from      = apply_filters( 'formiflex_action_email_from', $settings['from'] );
