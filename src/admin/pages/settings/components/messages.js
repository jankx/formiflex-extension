...
export default function Messages() {
	...
	return (
		<Fragment>
			<Card>
				<CardHeader>
					<h2>{ __( 'Form messages', 'formiflex' ) }</h2>
				</CardHeader>
			...
			<Card>
				<CardHeader>
					<h2>{ __( 'Missing value', 'formiflex' ) }</h2>
				</CardHeader>
			...
			<Card>
				<CardHeader>
					<h2>{ __( 'Pattern mismatch', 'formiflex' ) }</h2>
				</CardHeader>
			...
			<Card>
				<CardHeader>
					<h2>{ __( 'Out of range', 'formiflex' ) }</h2>
				</CardHeader>
			...
			<Card>
				<CardHeader>
					<h2>{ __( 'Wrong length', 'formiflex' ) }</h2>
				</CardHeader>
