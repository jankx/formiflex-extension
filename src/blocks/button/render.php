...
$config = wp_interactivity_config( 'formiflex' );
$state = wp_interactivity_state( 'formiflex' );
...
if ( $p->next_tag( 'div' ) ) {
	...
	$p->set_attribute( 'data-wp-class--wp-block-formiflex-button--loading', 'context.isLoading' );
}
