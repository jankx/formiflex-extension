...
function PatternExplorerSidebar( {
	...
	return (
		<div className={ baseClassName }>
			...
			/>
			{ ! searchValue && 'formiflex/form' === blockName && (
...
export function TemplatesModal( { clientId, blockName, onRequestClose } ) {
	...
	const patternCategories = [
		{
			slug: 'all',
			name: __( 'All', 'formiflex' ),
		},
		{
			slug: 'contact',
			name: __( 'Contact', 'formiflex' ),
		},
		{
			slug: 'leads',
			name: __( 'Top bar', 'formiflex' ),
		},
		{
			slug: 'question',
			name: __( 'Ad Block', 'formiflex' ),
		},
		{
			slug: 'login',
			name: __( 'Login', 'formiflex' ),
		},
	];
	...
	return (
		<Modal
			...
			isFullScreen
			title={ __( 'Choose a form', 'formiflex' ) }
