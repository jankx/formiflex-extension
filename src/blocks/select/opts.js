	...
	return options.map( ( obj, index ) => {
		return (
			<Flex
				key={ index }
				justify="flex-start"
				className={ 'formiflex-fields-row' }
			...
			>
				<FlexItem>
					<Tooltip
						text={ __( 'Mark selected', 'formiflex' ) }
						delay="200"
					>
						<CheckboxControl
				...
				{ showValue && (
					<FlexItem>
						<Tooltip
							text={ __( 'The value of the option', 'formiflex' ) }
							delay="200"
						>
							<TextControl
								placeholder={ __( 'Value', 'formiflex' ) }
								value={ obj.value }
								onChange={ ( val ) =>
				...
				<FlexItem>
					<Tooltip
						text={ __( 'The label of the option', 'formiflex' ) }
						delay="200"
					>
						<TextControl
							placeholder={ __( 'Label', 'formiflex' ) }
							value={ obj.label }
							onChange={ ( val ) =>
