		...
		<Fragment>
			...
			>
				...
				{ supported.includes( 'placeholder' ) && (
					<TextControl
						label={ __( 'Placeholder', 'formiflex' ) }
						value={ placeholder }
						onChange={ ( val ) =>
				...
				{ ! ( 'hidden' === type ) && (
					<ToggleControl
						label={ __( 'Show help message', 'formiflex' ) }
						checked={ showHelp }
						onChange={ ( newval ) =>
				...
				{ ( 'select' === fieldType ||
					...
					<ToggleControl
						label={
							'textarea' === fieldType
								? __( 'Enable Rich Text', 'formiflex' )
								: __( 'Advanced', 'formiflex' )
						}
						checked={ advanced }
						onChange={ ( newval ) =>
