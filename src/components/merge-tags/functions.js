...
export function getFieldsBlock() {
	const fields = [];
	const inputs =
		select( blockEditorStore ).getBlocksByName( 'formiflex/input' );
	const textareas =
		select( blockEditorStore ).getBlocksByName( 'formiflex/textarea' );
	const selects =
		select( blockEditorStore ).getBlocksByName( 'formiflex/select' );
	const outputs =
		select( blockEditorStore ).getBlocksByName( 'formiflex/output' );
...
export function validate() {
	const fields = {
		names: [],
		buttons:
			select( blockEditorStore ).getBlocksByName( 'formiflex/button' ),
	};
...
export function getConstraints() {
	...
	applyFilters( 'formiflex.constraints', fields, constraints );
